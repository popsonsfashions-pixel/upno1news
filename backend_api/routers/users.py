...
from backend_api.models.user import Role, UserInDB, UserResponse, UserUpdate, user_from_doc, user_to_response
...
async def update_current_user(
    ...
    doc_ref = db.users.document(current_user.id)
    
    # Filter update data - allow only specific fields for self-update
    update_data = {}
